...
export const fetchFilmsNextRequested = createAction("@FILMS/FETCH_FILMS_NEXT_REQUESTED");
...
export const updateFilmRatingSucceed = createAction("@FILMS/UPDATES_FILM_RATING_SUCCEED");
