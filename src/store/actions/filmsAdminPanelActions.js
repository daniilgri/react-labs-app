...
export const deleteFilmSucceed = createAction("@FILMS_ADMIN_PANEL/DELETE_FILM_SUCCEED");
...
export const addFilmSucceed = createAction("@FILMS_ADMIN_PANEL/ADD_FILM_SUCCEED");
export const addFilmFailed = createAction("@FILMS_ADMIN_PANEL/ADD_FILM_FAILED", payload => payload);

export const editFilmRequested = createAction(
  "@FILMS_ADMIN_PANEL/EDIT_FILM_REQUESTED",
  payload => payload
);
export const editFilmSucceed = createAction("@FILMS_ADMIN_PANEL/EDIT_FILM_SUCCEED");
