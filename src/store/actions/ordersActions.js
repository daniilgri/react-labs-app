...
export const fetchOrdersNextRequested = createAction("@ORDERS/FETCH_ORDERS_NEXT_REQUESTED");
...
export const cancelOrderFailed = createAction("@ORDERS/CANCEL_ORDER_FAILED", payload => payload);
