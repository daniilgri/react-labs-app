...
export const updateProfileSucceed = createAction(
  "@PROFILE/UPDATE_PROFILE_SUCCEED"
);
...
export const changePasswordSucceed = createAction(
  "@PROFILE/CHANGE_PASSWORD_SUCCEED"
);
